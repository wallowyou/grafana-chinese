...
const panelTemplate = `
  <div class="panel-container" ng-class="{'panel-container--no-title': !ctrl.panel.title.length}" ng-style="{'border': ctrl.panel.borderWidth + 'px solid ' + ctrl.panel.borderColor, 'border-radius': ctrl.panel.borderRadius + 'px'}">
