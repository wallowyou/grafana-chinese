      ...
      <div className={rowClasses}>
        <div className="query-editor-row__header">
          <div className="query-editor-row__ref-id" onClick={this.onToggleCollapse}>
            ...
            {isDisabled && <em className="query-editor-row__context-info">
              {/* Disabled */}
              禁用
              </em>}
          </div>
          ...
          <div className="query-editor-row__actions">
            ...
            <button className="query-editor-row__action" onClick={this.onDisableQuery} title="禁用/启用 查询">
              {isDisabled && <i className="fa fa-fw fa-eye-slash" />}
              {!isDisabled && <i className="fa fa-fw fa-eye" />}
            </button>
            <button className="query-editor-row__action" onClick={this.onRemoveQuery} title="移除查询">
              <i className="fa fa-fw fa-trash" />
            </button>
          </div>
        </div>
